...
from app.cache import check_cache_health, close_cache, init_cache
from app.core.config import settings
from app.core.database import check_db_connection, engine
from app.core.exceptions import ConflictError, ForbiddenError, NotFoundError
from app.kafka_consumer import is_consumer_running, start_consumer, stop_consumer

logger = logging.getLogger(__name__)

try:
    _APP_VERSION = version("client-service")
...
async def _lifespan(app: FastAPI):
    logger.info("Запуск client-service v%s", _APP_VERSION)
    ...
    try:
        ...
        logger.critical("Не удалось запустить Kafka consumer: %s", exc)
        raise
    ...
    logger.info("client-service остановлен")
...
async def readiness() -> JSONResponse:
    ...
    kafka_ok = is_consumer_running()
    all_ok = db_ok and cache_ok and kafka_ok
    ...
    return JSONResponse(
        ...
        content={
            ...
            "services": {
                ...
                "kafka_consumer": "ok" if kafka_ok else "unavailable",
            },
        },
    )
