...
def normalize_optional_text(v: str | None) -> str | None:
    """Нормализует текстовое поле: пустую строку приводит к None."""
    if v is None:
        return None
    stripped = v.strip()
    # Пустая строка семантически эквивалентна отсутствию текста
